...
if (!isDedicated) then {
	...
	fnc_usec_selfActions =		compile preprocessFileLineNumbers "dayz_code\fn_selfActions.sqf";							//Checks which Custom Actions for self
...
//Both
	...
	execVM "dayz_code\DynamicWeatherEffects.sqf";
	initialized = true;